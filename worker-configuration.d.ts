/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 887348a9eb950a4664d58ee72e74e8db)
// Runtime types generated with workerd@1.20260424.1 2026-04-17 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "DialReaderContainer";
	}
	interface Env {
		FLAGS: KVNamespace;
		IMAGES: R2Bucket;
		...
		AI: Ai;
		ASSETS: Fetcher;
		DIAL_READER: DurableObjectNamespace<import("./src/worker/index").DialReaderContainer>;
	}
}
